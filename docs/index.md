...
<div class="hero-banner">
  <img src="_static/jaqmc-white-large.svg" class="hero-logo dark-light" alt="">
  <p class="hero-tagline">JAX accelerated Quantum Monte Carlo</p>
  <div class="hero-buttons">
    <a class="hero-btn-primary" href="getting-started/quick-start.html">Get Started</a>
    <a class="hero-btn-secondary" href="https://github.com/bytedance/jaqmc">GitHub</a>
  </div>
</div>
```
