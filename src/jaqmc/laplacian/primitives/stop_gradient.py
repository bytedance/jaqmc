...
"""Forward Laplacian rules for stop-gradient primitives."""
...
STOP_GRADIENT_HANDLERS: dict[Primitive | str, LaplacianHandler] = {
    jax.lax.stop_gradient_p: wrap_without_fwd_laplacian(jax.lax.stop_gradient_p.bind),
}
