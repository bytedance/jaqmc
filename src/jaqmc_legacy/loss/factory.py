...
from jaqmc_legacy.loss import utils
from jaqmc_legacy.loss.spin_penalty import (
    SpinAuxData,
    SpinFuncState,
    make_spin_penalty,
)
from jaqmc_legacy.loss.overlap_penalty import (
    OverlapAuxData,
    OverlapFuncState,
    make_overlap_penalty,
)
from jaqmc_legacy.loss.vmc import VMCAuxData, VMCFuncState, make_vmc_loss
