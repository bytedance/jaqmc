...
using the pseudohamiltonian (PH) potential in JaQMC.
...
Returns:
    cfg: JaQMC ConfigDict describing the a dimer transition-metal atom with non metal single atom (X-O) system with PH pseudopotential.
"""
import re
