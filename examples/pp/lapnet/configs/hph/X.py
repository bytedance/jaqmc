...
Returns:
    cfg: JaQMC ConfigDict describing the TM single-atom system with HPH pseudopotential.
...
def get_config(input_str: str):
    ...
    cfg.system.atom_spin_configs = [(6,4)] # Manually set the number of spin up and spin down electrons
